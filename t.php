...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Tambo</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'tambo_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','tambo') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM tambo_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="tambo_night_output.php" method="post">
        <tr>
...
<?php require_once'tambo_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','tambo_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM tambo_night_tbl") or die($mysqli->error($mysqli));
