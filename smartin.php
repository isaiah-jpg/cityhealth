...
<body>
    <head>
        <title>San Martin Schedule</title>
        <style>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">San Martin de Porres</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'sanmartin_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sanmartin') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sanmartin_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="sanmartin_output.php" method="post">
        <tr>
...
<?php require_once'sanmartin_night.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sanmartin_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sanmartin_night_tbl") or die($mysqli->error($mysqli));
    ...
    <tr>
        <form action="sanmartin_night.php" method="post">
