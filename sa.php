...
<body>
    <head>
        <title>San Antonio Schedule</title>
        <style>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">San Antonio</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'sanantonio_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sanantonio') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sanantonio_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="sanantonio_output.php" method="post">
        <tr>
...
<?php require_once'sa_night.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sanantonio_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sanantonio_night_tbl") or die($mysqli->error($mysqli));
    ...
    <tr>
        <form action="sa_night.php" method="post">
