...
<body>
    <head>
        <title>San Dionisio Schedule</title>
        <style>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">San Dionisio</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'sandionisio_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sandionisio') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sandionisio_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="sandionisio_output.php" method="post">
        <tr>
...
<?php require_once'sd_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sandionisio_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sandionisio_night_tbl") or die($mysqli->error($mysqli));
        
        
        ?>
<form action="sd_night_output.php" method="post">
