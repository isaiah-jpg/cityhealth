...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Merville</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'merville_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','merville') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM merville_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="merville_output.php" method="post">
        <tr>
...
<?php require_once'mville_night.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','merville_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM merville_night_tbl") or die($mysqli->error($mysqli));
    ...
    <tr>
        <form action="mville_night.php" method="post">
