...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Sto.Niño</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'stonino_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','stonino') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM stonino_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="stonino_output.php" method="post">
        <tr>
...
<?php require_once'sn_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','stonino_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sto_nino_night_output") or die($mysqli->error($mysqli));
        
        
        ?>
<form action="sn_night_output.php" method="post">
