...
<body>
    <head>
        <title>Don Bosco Schedule</title>
        <style>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Don Bosco</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'dbosco_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','donbosco') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM donbosco_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="dbosco_output.php" method="post">
        <tr>
...
<?php require_once'donbosco_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','donbosco_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM donbosco_night_tbl") or die($mysqli->error($mysqli));
    ...
    <tr>
        <form action="donbosco_night_output.php" method="post">
