...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">BF</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'bf_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','bf') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM bf_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="bf_output.php" method="post">
        <tr>
...
<?php require_once'bf_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','bf_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM bf_night_tbl") or die($mysqli->error($mysqli));
    ...
    <tr>
        <form action="bf_night_output.php" method="post">
