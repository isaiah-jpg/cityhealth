...
<body>
    <head>
        <title>San Isidro Schedule</title>
        <style>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">San Isidro</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'sanisidro_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sanisidro') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM sanisidro_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="sanisidro_output.php" method="post">
        <tr>
...
<?php require_once'sanisidro_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','sanisidro_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM san_isidro_night_tbl") or die($mysqli->error($mysqli));
        
        
        ?>
<form action="sanisidro_night_output.php" method="post">
