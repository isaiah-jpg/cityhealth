...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Baclaran</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'bac_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','baclaran') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM baclaran_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="bac_output.php" method="post">
        <tr>
...
<?php require_once'bac_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','baclaran_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM baclaran_night_tbl") or die($mysqli->error($mysqli));
        
        
        ?>
<form action="bac_night_output.php" method="post">
