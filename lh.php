...
<body>
    <head>
        <title>La Huerta Schedule</title>
        <style>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">La Huerta</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'lh_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','lahuerta') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM lahuerta_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="lh_output.php" method="post">
        <tr>
...
<?php require_once'lahuerta_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','lahuerta_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM lahuerta_night_tbl") or die($mysqli->error($mysqli));
        
        
        ?>
<form action="lahuerta_night_output.php" method="post">
