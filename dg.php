...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Don Galo</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'dongalo_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','dongalo') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM dongalo_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="dongalo_output.php" method="post">
        <tr>
...
<?php require_once'dongalo_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','dongalo_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM dongalo_night_tbl") or die($mysqli->error($mysqli));
        
        
        ?>
<form action="dongalo_night_output.php" method="post">
