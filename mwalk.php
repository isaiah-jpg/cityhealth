...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Moonwalk</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'moonwalk_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','moonwalk') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM moonwalk_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="moonwalk_output.php" method="post">
        <tr>
...
<?php require_once'moonwalk_night.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','moonwalk_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM moonwalk_night_tbl") or die($mysqli->error($mysqli));
    ...
    <tr>
        <form action="moonwalk_night.php" method="post">
