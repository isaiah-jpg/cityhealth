...
<body>
    <head>
        <title>Marcelo Green Schedule</title>
        <style>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Marcelo Green</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'marcelogreen_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','marcelogreen') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM marcelogreen_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="marcelogreen_output.php" method="post">
        <tr>
...
<?php require_once'mgreen_night.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','marcelogreen_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM marcelogreen_night_output") or die($mysqli->error($mysqli));
    ...
    <tr>
        <form action="mgreen_night.php" method="post">
