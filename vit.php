...
<body>
    ...
    <h1 style="background:rgb(21, 25, 82);padding:0.7em; color:white;">Vitalez</h1>
    <center>
    ...
    <table>
        ...
        <?php require_once'vitalez_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','vitalez') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM vitalez_tbl") or die($mysqli->error($mysqli));
    ...
    <form action="vitalez_output.php" method="post">
        <tr>
...
<?php require_once'vitalez_night_output.php'; ?>
        <?php 
        
        $mysqli = new mysqli('localhost','root','','vitalez_night') or
        die($mysqli->error($mysqli));
        $result = $mysqli->query("SELECT * FROM vitalez_night_tbl") or die($mysqli->error($mysqli));
        
        
        ?>
<form action="vitalez_night_output.php" method="post">
